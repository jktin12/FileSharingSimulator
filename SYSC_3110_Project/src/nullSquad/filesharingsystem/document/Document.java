...
public class Document implements Serializable
{
	...
	/**
	 * @author Marc Tebo Creates a Document with a name, tag and producer who
	...
	/**
	 * @author Marc Tebo User who "likes" this document will be added to the
	 *         list of people who like this document
	...
	public boolean likeDocument(User user)
	{
		...
		// Iterate through all like listeners and notify that this document has
		// been liked
	...
	/**
	 * @author Marc Tebo User who wants to "unlike" this document will be
	 *         removed from the list of people who liked it
	...
	/**
	 * @author Marc Tebo Gets all users who have "liked" this document
	...
	/**
	 * @author Marc Tebo Returns string representation of the document
	 */
	...
	/**
	 * @author Marc Tebo Compares if two documents are the same
	...
	public boolean equals(Object o)
	{
		...
		return (d.getDocumentID() == this.docID && d.getDocumentName().equals(this.name) && d.getTag().equals(this.tag) && d.getProducer().equals(this.producer));
