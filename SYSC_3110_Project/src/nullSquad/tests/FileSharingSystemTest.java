...
public class FileSharingSystemTest {
	...
	public void testDeactivateUser() {
		...
		producer1.act(network, 1);
		assertTrue(!network.getAllDocuments().isEmpty());
		
		consumer1.followUser(producer1);
		producer1.followUser(consumer1);
		assertTrue(consumer1.getFollowers().contains(producer1));
		assertTrue(consumer1.getFollowing().contains(producer1));
