...
public class Document
{
	...
	/**
	 * @author Marc Tebo
	 *         Creates a Document with a name, tag and producer who created the
	 *         document
	 * 
	...
	/**
	 * @author Marc Tebo
	 *         User who "likes" this document will be added to the list of
	 *         people who like this document
	 * 
	...
	/**
	 * @author Marc Tebo
	 *         User who wants to "unlike" this document will be removed from the
